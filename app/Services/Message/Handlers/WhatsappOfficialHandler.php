...
class WhatsappOfficialHandler implements MessageHandlerInterface, SendsTypingIndicator, MarksMessagesAsRead
{
    ...
    {
        throw new ChannelCapabilityException('O WhatsApp Oficial não permite editar mensagens já enviadas.');
    }

    public function handleDeleteMessage(Message $message): bool
    {
        throw new ChannelCapabilityException('O WhatsApp Oficial não permite apagar mensagens já enviadas.');
    }
